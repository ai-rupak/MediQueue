  ...
  return (
    <div className='md:mx-10'>
        <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
            {/* -----Left Section------*/}
            <div className=''>
            <h1 className='text-2xl font-bold'>Medi<span className='text-[#4bb3b8]'>Queue</span>+</h1>
        ...
        <div>
            <hr />
            <p className='py-5 text-sm text-center'>Copyright © 2024 MediQueue - All Right Reserved.</p>
        </div>
    </div>
  )
}
